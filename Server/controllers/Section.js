...
// handler function to create a section
...
const updateSection = async (req, res) => {
  try {
    ...
    // await Section.findByIdAndUpdate(sectionId, {sectionName}, {new:true}); we can also write only this, will have no effect on code
